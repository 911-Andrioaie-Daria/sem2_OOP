...
void AdminGUI::initGUI() {
    ...
    buttonsLayout->addWidget(this->undoButton, 1,0,1,2);
    buttonsLayout->addWidget(this->redoButton,1,2,1,2);
    buttonsLayout->addWidget(this->statisticsButton, 2, 1, 1, 2);
...
void AdminGUI::connectSignalsAndSlots() {
    ...
    QObject::connect(this->undoButton, &QPushButton::clicked, this, &AdminGUI::undoAction);
    QObject::connect(this->undoShortcut, &QShortcut::activated, this, &AdminGUI::undoAction);
    QObject::connect(this->redoButton, &QPushButton::clicked, this, &AdminGUI::redoAction);
    QObject::connect(this->redoShortcut, &QShortcut::activated, this, &AdminGUI::redoAction);
...
void AdminGUI::undoAction() {
    ...
    catch(CustomException& undoException){
        QMessageBox::information(this, "No undo", QString::fromStdString(undoException.what()));
    }
}
...
void AdminGUI::redoAction() {
    try{
        ...
        QMessageBox::information(this, "No redo", QString::fromStdString(undoException.what()));
    }
}
