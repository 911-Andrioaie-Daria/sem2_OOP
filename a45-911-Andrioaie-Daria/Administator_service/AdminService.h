...
public:
    ...
    bool add_dog_service(string dog_breed, string dog_age, string dog_name, string dog_photograph);
    ...
    bool delete_dog_service(string dog_breed, string dog_name);
    ...
    bool update_dog_age(string dog_breed, string dog_name, string new_dog_age);
    ...
    /// \return true, if the dog was updated, false, if the dog does not exist or its attributes are not valid.
    bool update_dog_photograph(string dog_breed, string dog_name, string new_dog_photograph);
